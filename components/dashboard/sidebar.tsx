...
const navItems = [
  ...
  { icon: ShoppingCart, label: "Products", href: "/dashboard/products", active: true },
  { icon: Wallet, label: "Fund Wallet", href: "/dashboard/fund-wallet", active: false },
  { icon: ClipboardList, label: "My Orders", href: "/dashboard/orders", active: false },
  { icon: AlertTriangle, label: "Rules", href: "/dashboard/rules", active: false },
  { icon: FileText, label: "Terms Of Use", href: "/dashboard/terms", active: false },
  { icon: MessageSquare, label: "Verify SMS", href: "/dashboard/verify-sms", active: false },
  { icon: Users, label: "Join Group 1", href: "#", active: false },
  { icon: Users, label: "Join Group 2", href: "#", active: false },
]
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                item.active ? "text-violet-600 bg-violet-50 font-medium" : "text-gray-600 hover:bg-gray-50"
              }`}
            >
        ...
        {/* Help Center */}
        <div className="p-4">
          <div className="bg-gradient-to-r from-violet-100 to-cyan-100 rounded-xl p-4">
